...
const corsOptions = {
  origin: [
    "http://localhost:5173",
    "https://skilltrack-ed10c.firebaseapp.com",
    "https://skilltrack-ed10c.web.app",
  ],
  credentials: true,
  ...
  try {
    ...
    app.delete(
      ...
      async (req, res) => {
        const id = req.params.id;
        const query = { _id: new ObjectId(id) };
        console.log("delete class", query);
